 ...
 *
 * Each restore rule names the element MJML puts the class on: `td` for a
 * column, `div` for a section, and `table` for a full-width section, which
 * MJML wraps in a table rather than a div.
 */
export const VISIBILITY_STYLE = `    <mj-style>
      ...
      @media only screen and (max-width:479px) {
        ...
        table.pigeon-hide-desktop { display: table !important; }
        .pigeon-hide-mobile, td.pigeon-hide-mobile, div.pigeon-hide-mobile, table.pigeon-hide-mobile { display: none !important; }
      }
    </mj-style>`;
